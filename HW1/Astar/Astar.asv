...
classdef Astar
    ...
    methods
        ...
        function [path] = search(obj)
            ...
            % starting position
            eval_list(obj.start) = h(obj, obj.start);
            ...
            while true
                ...
                for index_neighbor=1:length(neighbors)
                    ...
                    % calculate cost
                    cost_g = g(obj, n_best, eval_list);
                    cost_n = cost(obj, n_best, neighbor);
                    cost_h = h(obj, neighbor);
                    eval = cost_g + cost_n + cost_h;
        ...
        function [path] = get_path_old(obj, eval_list)
            % initialization
            path = [];
        ...
        function [cost_g] = g(obj, n_best, eval_list)
            cost_g = eval_list(n_best) - h(obj, n_best);
        end
